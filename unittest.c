...
// int compareByPagerank(char *val, int outdegree, double pagerank, DLListNode
// *present)
// {
//     int result = 0;
...
// void insertSetOrdCountAndPageRank(DLListStr L, char *val, int count, double
// pagerank)
// {
...
//             L->first = newNode;
//         }
//         else if (compareByCountAndPagerank(val, count, pagerank, L->last) <
//         0)
//         {
//             L->last->next = newNode;
//             newNode->prev = L->last;
...
//             token = strtok(NULL, delim);
//         }
//         insertSetOrdPageRankAndoutDegree(pagerankList, url, out_degree,
//         page_rank);
//     }
//     fclose(fp);
// }

// void getResultList(DLListStr resultList, DLListStr invertedList, DLListStr
// pagerankList)
// {
...
//             {
//                 insertSetOrdCountAndPageRank(resultList, invNode->value,
//                 invNode->count, pagNode->pagerank);
//             }
